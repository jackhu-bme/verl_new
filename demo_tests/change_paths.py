...
# 读取原始 Parquet 文件
df = pd.read_parquet('/home/xufluo/ms_cxr_data/cxr_mini_crop/full.parquet')
...
# 保存为新的 Parquet 文件
df.to_parquet('/home/xufluo/ms_cxr_data/cxr_mini_crop/full_local.parquet', index=False)
