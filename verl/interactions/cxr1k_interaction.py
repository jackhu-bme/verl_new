...
class Cxr1kInteraction(BaseInteraction):
    ...
    async def generate_response(
        ...
        # if reward == 1.0:
        response = "Now the step 1 of cropping is finished, move to step 2 of diagnosis. Based on the cropped image after tool use, and the question, conduct the disease diagnosis with thinking process."
        #TODO: make this prompt better
        should_terminate_sequence = True

        return should_terminate_sequence, response, reward, {}
    
    async def crop_image(self, instance_id: str, image: str, **kwargs) -> Tuple[str, float, dict]:
        # TODO: finish
        pass
