...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='cxr20k_bal_tool_v2_async_rl_7b_v8.0.4_val_debug_rollout_t_0' \
    trainer.experiment_name='qwen2.5-vl_tool_7b_-cxr20k_v8.0.4_val_debug_rollout_t_0' \
    ...
    trainer.rollout_data_dir="$PROJECT_DIR/generations/qwen2.5-vl_tool_7b_-cxr20k_v8.0.4_val_debug_rollout_t_0/rollout" \
    trainer.validation_data_dir="$PROJECT_DIR/generations/qwen2.5-vl_tool_7b_-cxr20k_v8.0.4_val_debug_rollout_t_0/val" \
