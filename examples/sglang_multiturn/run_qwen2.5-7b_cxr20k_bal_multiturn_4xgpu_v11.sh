...
DESCRIPTION="no_dapo_aneal_clip_higher"
HARDWARE="4xgpu"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.temperature_annealing.start_steps=100 \
    actor_rollout_ref.rollout.temperature_annealing.final_steps=300 \
    ...
    data.train_files=$HOME/data/cxr_20k_bal_tool_v2/train.parquet \
    data.val_files=$HOME/data/cxr_20k_bal_tool_v2/test.parquet \
