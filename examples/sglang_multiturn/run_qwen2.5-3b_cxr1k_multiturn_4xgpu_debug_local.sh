...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='cxr1k_tool_3b' \
    trainer.experiment_name='qwen2.5-vl_tool_3b_-cxr1k' \
    ...
    data.train_files=$HOME/data/cxr_mini_1k_tool/train_mini.parquet \
    data.val_files=$HOME/data/cxr_mini_1k_tool/test_mini.parquet \
