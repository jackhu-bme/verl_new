...
VERSION="10.1.3" # fixed the dapo bug!
DATASET="cxr_20k_bal_tool_2_think"
MODEL="qwen2.5-vl-7b-instruct"
DESCRIPTION="dapo_clip_higher"
HARDWARE="4xgpu"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$HOME/data/cxr_20k_bal_tool_v2_2_think/train.parquet \
    data.val_files=$HOME/data/cxr_20k_bal_tool_v2_2_think/test.parquet \
