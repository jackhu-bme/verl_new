...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='cxr20k_bal_tool_v2_async_rl_7b_v8.0.4_val_debug_2_think_dapo_revised' \
    trainer.experiment_name='qwen2.5-vl_tool_7b_-cxr20k_v8.0.4_val_debug_2_think_dapo_revised' \
    ...
    trainer.rollout_data_dir="$PROJECT_DIR/generations/qwen2.5-vl_tool_7b_-cxr20k_v8.0.4_val_debug_2_think_dapo_revised/rollout" \
    trainer.validation_data_dir="$PROJECT_DIR/generations/qwen2.5-vl_tool_7b_-cxr20k_v8.0.4_val_debug_2_think_dapo_revised/val" \
