...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name="${DATASET}_${MODEL}_${VERSION}_${DESCRIPTION}_debug" \
    trainer.experiment_name="${MODEL}_${VERSION}_${DESCRIPTION}_debug" \
    ...
    data.train_files=$HOME/data/cxr_8k_bal_tool/train.parquet \
    data.val_files=$HOME/data/cxr_8k_bal_tool/test.parquet \
